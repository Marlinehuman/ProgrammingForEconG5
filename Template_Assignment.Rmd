...
`library(readxl)library(dplyr)library(purrr)files <- list.files("data/raw",pattern = "^kwb-20(20|21|22|23|24|25)\\.xlsx$",full.names = TRUE)`

`dataset <- files |>map(read_excel) |>bind_rows()`
