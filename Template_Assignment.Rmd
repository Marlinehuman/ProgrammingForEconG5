...
mdf <- mdf %>%
  mutate(housing_pressure = households / housing_stock)
...
mdf <- mdf %>%
  mutate(paradox_index = housing_pressure * vacancy_rate_percent)
...
How did the housing paradox index change before and after the ECB interest rate hike in 2022?
